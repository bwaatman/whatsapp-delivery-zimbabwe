...
exports.VehicleRestrictionService = void 0;
const database_1 = require("./database");
const OrderEconomicsService_1 = require("./OrderEconomicsService");
class VehicleRestrictionService {
    constructor() {
        this.orderEconomicsService = new OrderEconomicsService_1.OrderEconomicsService();
    }
    /**
     ...
     */
    async checkOrderEligibility(vendorLocation, customerLocation, vehicleType, estimatedPreparationTime = 30) {
        try {
     ...
     */
    async getEligibleVehicleTypes(vendorLocation, customerLocation, estimatedPreparationTime = 30) {
        try {
            ...
            for (const vehicleType of vehicleTypes) {
                const result = await this.checkOrderEligibility(vendorLocation, customerLocation, vehicleType, estimatedPreparationTime);
     ...
     */
    async isDriverEligibleForOrder(driverId, vendorLocation, customerLocation, estimatedPreparationTime = 30) {
        try {
...
exports.VehicleRestrictionService = VehicleRestrictionService;
//# sourceMappingURL=VehicleRestrictionService.js.map