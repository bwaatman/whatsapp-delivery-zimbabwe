...
exports.DriverSettlementService = void 0;
const database_1 = require("./database");
class DriverSettlementService {
    /**
     * Calculate weekly settlement for a driver
     */
    async calculateWeeklySettlement(driverId, weekStart, weekEnd) {
        try {
            ...
            const { data: debts, error: debtsError } = await database_1.supabase
                .from('driver_debts')
                .select('*')
     ...
     */
    async getWeeklySettlements(weekStart, weekEnd) {
        try {
            ...
            const { data: drivers, error: driversError } = await database_1.supabase
                .from('orders')
     ...
     */
    async getDriverSettlementReport(driverId, weekStart, weekEnd) {
        try {
...
exports.DriverSettlementService = DriverSettlementService;
//# sourceMappingURL=DriverSettlementService.js.map